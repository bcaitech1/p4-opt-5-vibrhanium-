...
class TorchTrainer:
    ...
    def test(
        ...
        # crit_MACs = 13863553
        # crit_F1 = 0.8342
        score_max = self.model_macs / 13863553.0
        if f1 < 0.5:
            score_f1 = 1
        elif f1 < 0.8342:
        ...
        print(
            f"Val score: {score}, Val/score_if_f1_underfifth: {score_f1_underfifth},"
            f"Val score_if_f1_low: {score_f1_low}, Val score_if_f1_high: {score_f1_high}"
        )
        wandb.log(
            {
                "Val/score": score,
                "Val/score_if_f1_underfifth": score_f1_underfifth,
                "Val/score_if_f1_low": score_f1_low,
                "Val/score_if_f1_high": score_f1_high,
            }
        )
